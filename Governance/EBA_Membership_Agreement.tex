...
THIS MEMBERSHIP AGREEMENT (the "Agreement") is effective as of this \TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=0.5cm]{day} of \TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=3cm]{ the month}, \TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=1cm]{in} (the “Effective Date”) by and between the European Blockchain Association (the “European Blockchain Association”) and \\ \TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=4.5cm]{Member: } (“Member”). Members of the European Blockchain Association shall be referred to collectively as the “Membership At-Large”. \\
...
\CheckBox[width=2em,bordercolor={white},backgroundcolor=gray!20]{I petition the EBA board of directors to waive my annual membership dues for one year from the date of this agreement. I commit to make in-kind contributions to the EBA in in lieu of paying the Annual Membership dues within one year.}
...
\begin{Form}
	...
	\sbox\TBox{Address (Institution): }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Address (Institution): \strut}\\[1ex] \\
	\sbox\TBox{Country (Institution): }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Country (Institution): \strut}\\[1ex] \\
	\sbox\TBox{Attention (Institution): }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Attention (Institution): \strut}\\[1ex] \\
	\sbox\TBox{Name of the Representative1: }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Name of the Representative: \strut}\\[1ex] \\
	\sbox\TBox{Title of the Representative1: }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Title of the Representative: \strut}\\[1ex] \\
    \sbox\TBox{E-Mail of the Representative: }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{E-Mail of the Representative: \strut}\\[1ex] \\
    \sbox\TBox{Telephone of the Representative: }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Telephone of the Representative: \strut}\\[1ex] \\
	\sbox\TBox{Ethereum Address (Institution): }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Ethereum Address (Institution): \strut}\\[1ex] \\
...
\begin{Form}
	...
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Telephone: \strut}\\[1ex] \\
	\sbox\TBox{GitHub Username (Developers only): }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{GitHub Username (Developers only): \strut}\\[1ex] \\
	\sbox\TBox{Ethereum Address: }%
	\TextField[backgroundcolor=gray!20,borderwidth=0,bordercolor={white},width=\dimexpr\linewidth-\wd\TBox]%
	{Ethereum Address: \strut}\\[1ex]
